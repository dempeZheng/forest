 ...
 */
public class ProxyBean implements FactoryBean<Object>, InitializingBean, MethodInterceptor, DisposableBean {

    private final static Logger LOGGER = LoggerFactory.getLogger(ProxyBean.class);
