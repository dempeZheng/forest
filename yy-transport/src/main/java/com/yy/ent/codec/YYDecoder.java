...
public class YYDecoder extends ChannelHandlerAdapter {
     ...
     * {@link #channelRead(io.netty.channel.ChannelHandlerContext, Object)} call. This may be
    ...
    /**
     * Called once data should be decoded from the given {@link io.netty.buffer.ByteBuf}. This
     * method will call {@link #decode(io.netty.channel.ChannelHandlerContext, io.netty.buffer.ByteBuf, java.util.List)} as
     * long as decoding should take place.
     *
     * @param ctx the {@link io.netty.channel.ChannelHandlerContext} which this
    ...
    /**
     * Decode the from one {@link io.netty.buffer.ByteBuf} to an other. This method will be
     * called till either the input {@link io.netty.buffer.ByteBuf} has nothing to read anymore,
     * till nothing was read from the input {@link io.netty.buffer.ByteBuf} or till this method
     * returns {@code null}.
     *
     * @param ctx the {@link io.netty.channel.ChannelHandlerContext} which this
     *            {@link io.netty.handler.codec.ByteToMessageDecoder} belongs to
    ...
    /**
     * Is called one last time when the {@link io.netty.channel.ChannelHandlerContext} goes
     ...
     * {@link #decode(io.netty.channel.ChannelHandlerContext, io.netty.buffer.ByteBuf, java.util.List)} but sub-classes may
