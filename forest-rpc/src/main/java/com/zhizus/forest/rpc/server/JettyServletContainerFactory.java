 ...
 */
public class JettyServletContainerFactory
        extends AbstractEmbeddedServletContainerFactory implements ResourceLoaderAware {

    private static final String THREAD_POOL_NAME = "jetty-server";
    ...
    /**
     * Create a new {@link JettyServletContainerFactory} instance.
     */
    public JettyServletContainerFactory() {
        super();
    }

    /**
     * Create a new {@link JettyServletContainerFactory} that listens for requests
     * using the specified port.
     *
     * @param port the port to listen on
     */
    public JettyServletContainerFactory(int port) {
        super(port);
    }

    /**
     * Create a new {@link JettyServletContainerFactory} with the specified
     * context path and port.
     *
     * @param contextPath root the context path
     * @param port        the port to listen on
     */
    public JettyServletContainerFactory(String contextPath, int port) {
    ...
    public EmbeddedServletContainer getEmbeddedServletContainer(
        ...
        serverConnector.setHost(addr.getHostName());
        serverConnector.setPort(addr.getPort());
